...
while($news = mysql_fetch_array($data)) { ?>
  <div class="item" id="<?php echo $news['id']; ?>" style="margin-bottom:48px">
    <h2><?php echo $news['title']; ?></h2>
    <h4><?php echo str_replace('-', '/', substr($news['modified'], 0, 10)); ?></h4>
    <div class="half">
      <figure><img src="../../uploads/<?php echo $news['image']; ?>" /></figure>
    </div><div class="half">
      <div class="content"><p><?php echo substr($news['content'], 0, 390) . '...'; ?></p></div>
      <a href="../show/<?php echo str_replace(' ', '-', $news['title']); ?>" class="smooth">Read more<i class="fa fa-angle-right"></i></a>
    </div>
  </div>
<?php } ?>
	  <div style="text-align:center">
	    <a href="../#product" class="button smooth" title="Rhino Agriwash Defender - Automatic drive-through Vehicle disinfection and Wheel washing system download product specifications PDF">Products</a>
      </div>
    </div>
  </div>
  <footer>
